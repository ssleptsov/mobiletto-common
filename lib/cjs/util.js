...
exports.rand = exports.closeStream = exports.writeStream = exports.readStream = exports.isReadable = exports.isAsyncGenerator = void 0;
...
const rand = (len) => crypto_1.default.randomBytes(len).toString("hex").substring(0, len);
exports.rand = rand;
